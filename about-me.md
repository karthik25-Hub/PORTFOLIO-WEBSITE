# About me — content source of truth

> Edit this file (or ask Claude Code to) whenever something changes. The site reads
> from here. Anything in [brackets] is a placeholder to replace.
...
## Education
- 2023 – present — MSc Energy and Nuclear Engineering, Università degli Studi di Padova, Italy
  Thesis: Impact of battery storage technologies on electricity market prices (expected 07/2026)
- 2018 – 2022 — BSc Engineering Sciences, University of Rome Tor Vergata, Rome, Italy
...
## Certifications
- Clean Tech Academy — Politecnico di Torino, Jan 2026
- McKinsey Forward Program — McKinsey & Company, Dec 2025
- Green Digital Certificate Program — INCO Academy, Nov 2025
- Business Analysis & Process Management — Coursera, Nov 2024
- Solar Energy Codes, Permitting and Zoning — University at Buffalo (Coursera), Nov 2024
...
Ecoinvent, SolidWorks (CAD), Microsoft Office Suite, Google Workspace.

### Business & data
Financial modelling, DCF analysis, market research, competitive analysis, business process
management, SWOT analysis, stakeholder analysis, data visualisation.

### Soft skills
Entrepreneurial mindset, analytical reasoning, cross-functional teamwork, multicultural
communication, time and priority management.

## Languages
- Telugu — mother tongue (C2)
- English — C1 (listening/reading), B2 (speaking/writing)
- Hindi — B2
- Italian — B1 (listening/reading), A2 (speaking/writing)
